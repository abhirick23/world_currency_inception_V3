...
cd/gdrive/MyDrive/world_currency/
...
train_dataset = image_dataset_from_directory('/gdrive/MyDrive/world_currency/',
                                             shuffle=True,
...
model.save('world_currency_inceptionV3.h5')